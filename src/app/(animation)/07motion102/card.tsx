              ...
              filter: "blur(0px)",
					...
					>
						...
						<p className="text-neutral-600 mt-2 text-xs">
							A motion library, {"let's"} get on with it.
						</p>
						<div className="flex items-center justify-center">
							<button
								onClick={() => setOpen(false)}
								className="flex items-center gap-1 text-xs mt-4 shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.4)] rounded-md px-2 py-1"
							>
							...
							>
								...
								<div className="flex gap-2 p-4">
									...
									<div className="flex flex-col">
										...
										<p className="text-[10px] text-neutral-400 mt-1">
											Super fast deliveery at warp speed
										</p>
									</div>
								</div>
